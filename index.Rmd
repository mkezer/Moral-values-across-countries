...
> The revised version looks much better. You can immediately see interesting patterns such as Spain's scores. The colors are not that nice, though. Also, it'd be nice to see the grand mean to have a general reference category.
